...
| Microsoft Visual Studio |Visual Studio 2015 | 省略可。 <br/><br/>BizTalk Server アプリケーションをビルドする開発環境を提供します。 Ultimate Edition を推奨しますが、Premium および Professional もサポートされます。 BizTalk Server 開発ツールと SDK で必要です。 |
