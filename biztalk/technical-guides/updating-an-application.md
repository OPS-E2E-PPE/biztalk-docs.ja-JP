...
ms.locfileid: "22301866"
---
# <a name="updating-an-application"></a>アプリケーションの更新
このセクションでは、運用環境に展開した後、BizTalk アプリケーションを更新する方法について説明します。  
  
## <a name="in-this-section"></a>このセクションの内容  
  
-   [アプリケーションの更新のベスト プラクティス](../technical-guides/best-practices-for-updating-applications.md)  
  
-   [アプリケーションの更新との成果物の既知の問題](../technical-guides/known-issues-with-updating-applications-and-artifacts.md)  
