...
-   [BAM プライマリ インポート データベースのボトルネックを特定する方法](../technical-guides/how-to-identify-bottlenecks-in-the-bam-primary-import-database.md)  
  
-   [ディスク Contention2 を回避する方法](../technical-guides/how-to-avoid-disk-contention2.md)