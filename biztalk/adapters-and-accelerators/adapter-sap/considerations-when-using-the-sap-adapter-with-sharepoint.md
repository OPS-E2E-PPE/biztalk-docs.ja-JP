...
##  <a name="Custom_Web_Part"></a><span data-ttu-id="c9920-132">カスタム Web パーツに関連する問題</span><span class="sxs-lookup"><span data-stu-id="c9920-132">Issues Involving Custom Web Parts</span></span>  
...
###  <a name="Issue1"></a><span data-ttu-id="c9920-135">問題 1: 複数の値に基づいて Microsoft Office SharePoint Server で 1 つのレコードを表示するオプションと制限</span><span class="sxs-lookup"><span data-stu-id="c9920-135">Issue 1: Limitation with displaying a single record in Microsoft Office SharePoint Server based on multiple values</span></span>  
