...
|N (数値の文字列) *|RFC_NUM|xsd:int 場合 lenrth < 9 を =<br />xsd:long 場合長さ 9 > および < = 19<br />xsd:string 場合長さ > 19|Int32<br />long<br />文字列|-|  
...
|TIMS (時刻フィールド)|RFC_TIME|xsd:string|文字列|HHMMSS 形式で指定|  
...
|--------------|-------------------------------------------------|------------------------------------------------|  
|RFC_BCD|**XSD パターン ファセット**<br /><br /> **小数点以下桁数は 0:**`"([\\-]{0,1})(([0-9]{1,"`  `+ digitsBeforeDecimal +`  `"}))"`<br /><br /> **1 つまたは複数の小数点以下桁数:**`"([\\-]{0,1})(([0-9]{0,"` + `digitsBeforeDecimal +``"}\\.[0-9]{0,"``+ digitsAfterDecimal +``"})&#124;([0-9]{1,"``+ digitsBeforeDecimal +``"}))"`|同じ|  
