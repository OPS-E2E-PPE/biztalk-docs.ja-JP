...
3.  <span data-ttu-id="d1191-106">新しい Swift MX メッセージ ウィンドウで **アップロード**です。</span><span class="sxs-lookup"><span data-stu-id="d1191-106">In New Swift MX Messages window, click **Upload**.</span></span>  
...
7.  <span data-ttu-id="d1191-111">新規 SWIFT MX メッセージで: \<MessageType\> Namespace ボックスで、型のウィンドウ **http://schemas.microsoft.com/BizTalk/Solutions/FinancialServices/SWIFT/EnvelopeMX_\<MessageType\>** 、順にクリック**OK**.</span><span class="sxs-lookup"><span data-stu-id="d1191-111">In the New SWIFT MX Messages: \<MessageType\> window, in the Namespace box, type **http://schemas.microsoft.com/BizTalk/Solutions/FinancialServices/SWIFT/EnvelopeMX_\<MessageType\>**, and then click **OK**.</span></span>