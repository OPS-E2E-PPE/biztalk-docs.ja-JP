...
-   各メッセージ スキーマのターゲット名前空間は **http://schemas.microsoft.com/BizTalk/Solutions/FinancialServices/SWIFT/Category*z*/MT*zxx * * *、どこ*z*メッセージ カテゴリ (メッセージの種類の最初の桁) と*zxx*は、メッセージの種類。  
