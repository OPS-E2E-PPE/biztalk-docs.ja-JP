...
|**配信の監視 (ブロック 2) (省略可能)**|場合は、優先順位は**U**配信を監視する必要があります。<br /><br /> **1** = 警告の配信不能<br /><br /> または<br /><br /> **3** = 警告の配信不能と配信通知します。<br /><br /> 場合は、優先順位は**N**配信を監視する必要があります。<br /><br /> **2**配信通知を =<br /><br /> または<br /><br /> 対象外の情報|  
...
|**出力日付 (ブロック 2)**|出力日付では、受信側のローカルは、次の形式で書き込まれます。YYMMDD します。|  
|**出力時間 (ブロック 2)**|次の形式で、受信側のローカル出力時刻が書き込まれます。HHMM します。|  
