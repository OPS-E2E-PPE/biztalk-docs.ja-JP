...
##  <span data-ttu-id="fd33c-109"><a name="SSO"></a>SharePoint での SSO アプリケーションの作成</span><span class="sxs-lookup"><span data-stu-id="fd33c-109"><a name="SSO"></a> Creating an SSO Application in SharePoint</span></span>  
...
##  <span data-ttu-id="fd33c-134"><a name="SSP"></a>共有サービス プロバイダーを作成します。</span><span class="sxs-lookup"><span data-stu-id="fd33c-134"><a name="SSP"></a> Creating a Shared Services Provider</span></span>  
...
##  <span data-ttu-id="fd33c-141"><a name="Import"></a>アプリケーション定義ファイルのインポート</span><span class="sxs-lookup"><span data-stu-id="fd33c-141"><a name="Import"></a> Importing the Application Definition File</span></span>  
