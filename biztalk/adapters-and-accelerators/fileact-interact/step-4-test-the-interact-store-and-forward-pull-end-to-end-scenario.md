---
title: 手順 4:InterAct ストア アンド フォワード (プル) エンド ツー エンド シナリオのテスト |Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
ms.author: mandia
manager: anneta
ms.openlocfilehash: 7654179846bb7d5a37ecf55aee6bd59e46bdb0e8
...
---
# <a name="step-4-test-the-interact-store-and-forward-pull-end-to-end-scenario"></a>手順 4:InterAct ストア アンド フォワード (プル) エンド ツー エンドのシナリオをテストします。
このセクションの手順を開始する前に行う必要があります[手順 3 b:InterAct ストア アンド フォワード (プル) シナリオ用の動的送信ポートとオーケストレーションをバインド](../../adapters-and-accelerators/fileact-interact/step-3b-bind-orchestration-with-dynamic-send-port-for-interact-scenario.md)します。  
