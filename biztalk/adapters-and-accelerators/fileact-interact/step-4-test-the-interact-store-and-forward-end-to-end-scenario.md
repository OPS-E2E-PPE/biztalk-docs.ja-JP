...
---
# <a name="step-4-test-the-interact-store-and-forward-end-to-end-scenario"></a>手順 4: InterAct ストアと転送のエンド ツー エンド シナリオをテストします。
このセクションの手順を開始する前に行う必要があります[ステップ 3 D: InterAct ストア アンド フォワードのシナリオの対話する送信ポートを追加](../../adapters-and-accelerators/fileact-interact/step-3d-add-an-interact-send-port-for-the-interact-store-and-forward-scenario.md)です。  
