...
ms.locfileid: "22224130"
---
# <a name="step-4a-start-the-swiftnet-service-for-the-interact-store-and-forward-scenario"></a>手順 4 a: サービスを開始します SWIFTNet InterAct ストアと転送シナリオ
この手順を開始する前に行う必要があります[ステップ 3 D: InterAct ストア アンド フォワードのシナリオの対話の送信ポート追加](../../adapters-and-accelerators/fileact-interact/step-3d-add-an-interact-send-port-for-the-interact-store-and-forward-scenario.md)です。  
