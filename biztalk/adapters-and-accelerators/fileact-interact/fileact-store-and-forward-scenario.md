...
---
# <a name="fileact-store-and-forward-scenario"></a>FileAct ストア アンド フォワードのシナリオ
このシナリオの手順を開始する前に行う必要があります[、チュートリアルを使用する準備](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md)です。  
