...
---
# <a name="swift-send-adapter-initialization"></a>SWIFT 送信アダプターの初期化
SWIFT にメッセージを送信する前に送信アダプターを初期化する必要があります。 次の図は、初期化シーケンスを示します。  
  
 ![送信アダプターの初期化シーケンス](../../adapters-and-accelerators/fileact-interact/media/1e395167-21e7-4f1e-b2da-d7f0f57cd0f8.gif "1e395167-21e7-4f1e-b2da-d7f0f57cd0f8")  
