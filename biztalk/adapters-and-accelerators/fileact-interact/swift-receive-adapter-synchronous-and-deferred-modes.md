...
---
# <a name="swift-receive-adapter-synchronous-and-deferred-modes"></a>SWIFT 受信アダプターの同期および遅延モード
SWIFTNet リンク (SNL) サーバー アプリケーションは、2 つのモードで動作できます。 同期および遅延モード。 同期モードでは、サーバー アプリケーションは、クライアント アプリケーションへのビジネス応答を送信します。 遅延のモードでは、サーバー アプリケーションは、クライアント アプリケーションに技術確認を送信します。  
  
 次の図は、シーケンスを示します。  
  
 ![受信アダプターの同期および遅延モード](../../adapters-and-accelerators/fileact-interact/media/2fd504f9-5ee5-4461-a354-54c8c2f33230.gif "2fd504f9-5ee5-4461-a354-54c8c2f33230")  
  
 次の図は、受信側の高レベルな表現を示しています。  
  
 ![受信アダプター シナリオ](../../adapters-and-accelerators/fileact-interact/media/b7cfeecb-3783-432b-886e-a77961500ad5.gif "b7cfeecb-3783-432b-886e-a77961500ad5")  
