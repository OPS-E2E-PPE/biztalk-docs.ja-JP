...
---
# <a name="step-4a-start-the-swiftnet-service-for-the-fileact-store-and-forward-pull-scenario"></a>手順 4 a: FileAct ストア アンド フォワード (プル) シナリオの SWIFTNet サービスの開始
この手順を開始する前に行う必要があります[手順 3 b: FileAct ストア アンド フォワード (プル) シナリオ用の動的送信ポートにオーケストレーションをバインド](../../adapters-and-accelerators/fileact-interact/step-3b-bind-orchestration-with-dynamic-send-for-fileact-store-and-forward.md)です。  
  
### <a name="to-start-the-swiftnet-service"></a>SWIFTNet サービスを開始するには  
  
-   開くリモート API コマンド プロンプト ウィンドウで「 **SWIFTNET 開始**、ENTER キーを押します。  
