...
ms.locfileid: "22223170"
---
# <a name="step-4a-start-the-swiftnet-service"></a>手順 4 a: SWIFTNet サービスの開始
この手順を開始する前に行う必要があります[ステップ 3 e: リアルタイム シナリオでは対話操作の送信ポートを追加](../../adapters-and-accelerators/fileact-interact/step-3e-add-an-interact-send-port-for-the-interact-real-time-scenario.md)です。  
