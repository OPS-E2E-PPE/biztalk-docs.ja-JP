...
---
# <a name="step-4-test-fileact-real-time-end-to-end-scenario"></a>手順 4: FileAct エンド ツー エンドのリアルタイムのシナリオをテストします。
このセクションの手順を開始する前に行う必要があります[ステップ 3 f: ソフトウェア HandleFileEventRequest メッセージのキャプチャに FileAct リアルタイム シナリオでは、ファイル送信ポートを追加する](../../adapters-and-accelerators/fileact-interact/step-3f-add-file-send-port-to-get-sw-handlefileeventrequest-messages--fileact.md)です。  
