...
---
# <a name="step-4a-start-the-swiftnet-service-for-the-fileact-real-time-scenario"></a>手順 4 a: FileAct リアルタイム シナリオの SWIFTNet サービスの開始
この手順を開始する前に行う必要があります[ステップ 3 e: Sw:ExchangeFileResponse メッセージのキャプチャに FileAct リアルタイム シナリオでは、ファイル送信ポートの追加](../../adapters-and-accelerators/fileact-interact/step-3e-add-file-send-port-to-get-sw-exchangefileresponse-message-for-fileact.md)です。  
