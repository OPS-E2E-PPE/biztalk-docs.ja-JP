...
---
# <a name="step-2-create-send-ports-and-receive-ports-for-the-fileact-store-and-forward-pull-scenario"></a>手順 2: 送信ポートを作成し、FileAct ストア アンド フォワード (プル) シナリオの受信ポート
手順を完了、[手順 1: SWIFT アダプター FileAct ストア アンド フォワード (プル) シナリオ用に構成](../../adapters-and-accelerators/fileact-interact/step-1-configure-the-swift-adapter-for-fileact-store-and-forward-pull-scenario.md)のこのセクションの手順を開始する前にします。
