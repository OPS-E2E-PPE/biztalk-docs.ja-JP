...
-   [ステップ 3 f: ソフトウェア HandleFileEventRequest メッセージをキャプチャする FileAct リアルタイム シナリオの FILE 送信ポートの追加](../../adapters-and-accelerators/fileact-interact/step-3f-add-file-send-port-to-get-sw-handlefileeventrequest-messages--fileact.md)