...
---
# <a name="fileact-real-time-scenario"></a>FileAct リアルタイム シナリオ
このシナリオを開始する前に行う必要があります[、チュートリアルを使用する準備](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md)です。  
