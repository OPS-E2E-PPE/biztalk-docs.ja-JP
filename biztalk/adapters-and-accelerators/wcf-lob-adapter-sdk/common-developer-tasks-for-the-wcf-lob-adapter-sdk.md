...
-   [WCF LOB Adapter SDK の主要なコンポーネント](key-components-of-the-wcf-lob-adapter-sdk.md) 
  
-   [チャネル レイヤーの拡張](https://docs.microsoft.com/dotnet/framework/wcf/extending/extending-the-channel-layer)  
...
-   [基本的な Windows Communication Foundation の概念](https://docs.microsoft.com/dotnet/framework/wcf/fundamental-concepts)  
  
-   [ホスティング サービス](https://docs.microsoft.com/dotnet/framework/wcf/hosting-services)  
