...
##  <span data-ttu-id="e2dba-105"><a name="FailoverPartner"></a>SQL アダプターの接続 URI</span><span class="sxs-lookup"><span data-stu-id="e2dba-105"><a name="FailoverPartner"></a> The Connection URI for the SQL Adapter</span></span>  
