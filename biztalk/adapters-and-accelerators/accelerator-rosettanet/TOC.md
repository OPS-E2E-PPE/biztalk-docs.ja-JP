...
#### [手順 1: ホーム組織の作成](step-1-create-the-home-organization.md)
#### [手順 2: 取引先組織の作成](step-2-create-the-partner-organization.md)
#### [手順 3: Partner Interface Process の編集](step-3-edit-the-partner-interface-process.md)
#### [手順 4: 取引先アグリーメントの作成](step-4-create-a-trade-agreement.md)
...
##### [手順 1: 証明機関の作成](step-1-creating-a-certification-authority.md)
##### [手順 2: パブリック証明書とプライベート証明書の作成](step-2-creating-public-and-private-certificates.md)
##### [手順 3: パブリック証明書とプライベート証明書のインポート](step-3-importing-public-and-private-certificates.md)
##### [手順 4: IIS で Secure Sockets Layer の有効化](step-4-enabling-secure-sockets-layer-in-iis.md)
#### [Contoso ソリューションの作成と構成](creating-and-configuring-the-contoso-solution.md)
##### [手順 1: Contoso ホーム組織の作成](step-1-creating-the-contoso-home-organization.md)
##### [手順 2: Fabrikam 取引先組織の作成](step-2-creating-the-fabrikam-partner-organization.md)
##### [手順 3: Contoso 0C2 取引先契約の作成](step-3-creating-the-contoso-0c2-trading-partner-agreement.md)
...
##### [手順 1: Fabrikam ホーム組織の作成](step-1-creating-the-fabrikam-home-organization.md)
##### [手順 2: Contoso 取引先組織の作成](step-2-creating-the-contoso-partner-organization.md)
##### [手順 3: Fabrikam 0C2 取引先契約の作成](step-3-creating-the-fabrikam-0c2-trading-partner-agreement.md)
...
##### [手順 1: 0C2 要求の送信](step-1-submitting-a-0c2-request.md)
##### [手順 2: 0C4 クエリの送信](step-2-submitting-a-0c4-query.md)
##### [手順 3: 3A2 要求の送信](step-3-submitting-a-3a2-request.md)
...
###### [手順 1: Contoso Price and Availability Request のための新しい BizTalk ソリューションの作成](step-1-create-new-biztalk-solution-for-contoso-price-and-availability-request.md)
...
###### [手順 3: BizTalk マッパーを使用した Price and Availability プロジェクト用の Contoso LOB アプリケーション マップの作成](step-3-create-contoso-lob-application-map-for-price-and-availability-in-mapper.md)
##### [Contoso の BizTalk ポートの作成と構成](creating-and-configuring-biztalk-ports-for-contoso.md)
###### [手順 1: Contoso アセンブリへの厳密な名前の割り当て](step-1-assigning-a-strong-name-to-the-contoso-assembly.md)
...
###### [手順 1: 既存の Contoso ソリューションへの既存の BizTalk プロジェクトの追加](step-1-adding-an-existing-biztalk-project-to-the-existing-contoso-solution.md)
###### [手順 2: Contoso 用のボキャブラリの定義と公開](step-2-defining-and-publishing-the-vocabulary-for-contoso.md)
###### [手順 3: Contoso のビジネス ポリシーの定義、公開、展開](step-3-defining-publishing-and-deploying-the-business-policy-for-contoso.md)
...
##### [手順 1: 組織および取引先契約の作成](step-1-creating-the-organizations-and-trading-partner-agreement.md)
...
### [トラブルシューティング: 問題と解決策](troubleshooting-issues-and-resolutions3.md)
