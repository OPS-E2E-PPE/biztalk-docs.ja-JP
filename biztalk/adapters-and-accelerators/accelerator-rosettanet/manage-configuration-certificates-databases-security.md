...
このセクションでは、構成、監視、および管理を効果的に使用できる概念および手順について、[!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)]アプリケーション環境。  
...
-   [送信者の ASPX ページをセキュリティで保護します。](../../adapters-and-accelerators/accelerator-rosettanet/securing-the-sender-aspx-page.md)  
  
-   [サービス拒否攻撃から保護](../../adapters-and-accelerators/accelerator-rosettanet/defending-against-denial-of-service-attacks.md)  
