...
---
# <a name="step-4-creating-the-fabrikam-0c4-trading-partner-agreement"></a>手順 4: Fabrikam 0 C 4 つの取引先アグリーメントの作成
Contoso と Fabrikam、Microsoft® を使用して間の取引先パートナー契約を作成するこの手順で[!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)]管理コンソール。 0C4 PIP (Partner Interface Process) のための新しい取引先アグリーメントを作成します。  
