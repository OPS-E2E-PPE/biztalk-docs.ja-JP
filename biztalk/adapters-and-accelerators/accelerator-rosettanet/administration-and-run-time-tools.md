...
## <a name="biztalk-administration-console"></a>BizTalk 管理コンソール  
 BizTalk 管理コンソールを使用して、実際のビジネス データのレポート、分析、およびデバッグを実行でき、ビジネス プロセスの最適化に役立ちます。 また、[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)] ファームの状態を監視したり、特定のイベントやメッセージを追跡し表示することができます。  
