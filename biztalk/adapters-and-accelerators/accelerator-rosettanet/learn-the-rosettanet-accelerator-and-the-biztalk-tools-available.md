...
---
# <a name="about-the-rosettanet-accelerator"></a>RosettaNet accelerator について
[!INCLUDE[btsCoName](../../includes/btsconame-md.md)]® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)] は、RosettaNet 規格に基づいてハイテク製造分野のコンピュータ アプリケーション間でデータ交換を処理する包括的なソリューションです。 この一連のドキュメントを参照して、[!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] のサービス、性能、および機能について理解してください。  
...
-   [BizTalk Accelerator for RosettaNet のしくみ](../../adapters-and-accelerators/accelerator-rosettanet/how-biztalk-accelerator-for-rosettanet-works.md)  
