...
### <a name="to-start-the-btarn-management-console"></a><span data-ttu-id="9f073-105">BTARN 管理コンソールを起動するには</span><span class="sxs-lookup"><span data-stu-id="9f073-105">To start the BTARN Management Console</span></span>  
  
-   <span data-ttu-id="9f073-106">をクリックして**開始**、 をポイント**すべてのプログラム**、 をポイント**Microsoft BizTalk\<バージョン\>Accelerator for RosettaNet**をクリックして**[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]** 管理コンソールです。</span><span class="sxs-lookup"><span data-stu-id="9f073-106">Click **Start**, point to **All Programs**, point to **Microsoft BizTalk \<version\> Accelerator for RosettaNet**, and then click **[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]** Management Console.</span></span>  
  
### <a name="to-create-the-3a2-trading-partner-agreement"></a><span data-ttu-id="9f073-107">3A2 取引先アグリーメントを作成するには</span><span class="sxs-lookup"><span data-stu-id="9f073-107">To create the 3A2 trading partner agreement</span></span>  
  
1.  <span data-ttu-id="9f073-108"> **[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]** 管理コンソールで、展開[!INCLUDE[btaBTARNNoVersionui](../../includes/btabtarnnoversionui-md.md)]を右クリックして**契約**、 をポイント**新規**、クリックして**アグリーメント**.</span><span class="sxs-lookup"><span data-stu-id="9f073-108">In the **[!INCLUDE[BTARN_CurrentVersion_abbrev](../../includes/btarn-currentversion-abbrev-md.md)]** Management Console, expand [!INCLUDE[btaBTARNNoVersionui](../../includes/btabtarnnoversionui-md.md)], right-click **Agreements**, point to **New**, and then click **Agreement**.</span></span>  
  
2.  <span data-ttu-id="9f073-109">**新しいアグリーメントのプロパティ** ダイアログ ボックスで、**全般** タブで、次の操作します。</span><span class="sxs-lookup"><span data-stu-id="9f073-109">In the **New Agreement Properties** dialog box, on the **General** tab, do the following:</span></span>  
  
    |<span data-ttu-id="9f073-110">プロパティ</span><span class="sxs-lookup"><span data-stu-id="9f073-110">Use this</span></span>|<span data-ttu-id="9f073-111">目的</span><span class="sxs-lookup"><span data-stu-id="9f073-111">To do this</span></span>|  
    |--------------|----------------|  
    |<span data-ttu-id="9f073-112">**名前**</span><span class="sxs-lookup"><span data-stu-id="9f073-112">**Name**</span></span>|<span data-ttu-id="9f073-113">型**Fabrikam_To_Contoso_3A2**です。</span><span class="sxs-lookup"><span data-stu-id="9f073-113">Type **Fabrikam_To_Contoso_3A2**.</span></span>|  
...
3.  <span data-ttu-id="9f073-126">クリックして、**ポート**タブをクリックし、次の操作します。</span><span class="sxs-lookup"><span data-stu-id="9f073-126">Click the **Ports** tab, and then do the following:</span></span>  
    ...
    |<span data-ttu-id="9f073-127">プロパティ</span><span class="sxs-lookup"><span data-stu-id="9f073-127">Use this</span></span>|<span data-ttu-id="9f073-128">目的</span><span class="sxs-lookup"><span data-stu-id="9f073-128">To do this</span></span>|  
    |--------------|----------------|  
    |<span data-ttu-id="9f073-129">**アクションの URL**</span><span class="sxs-lookup"><span data-stu-id="9f073-129">**Action URL**</span></span>|<span data-ttu-id="9f073-130">型**https://<fabrikam_machine>/BTARNApp/RNIFReceive.aspx**</span><span class="sxs-lookup"><span data-stu-id="9f073-130">Type **https://<fabrikam_machine>/BTARNApp/RNIFReceive.aspx**</span></span>|  
...
## <a name="see-also"></a><span data-ttu-id="9f073-137">参照</span><span class="sxs-lookup"><span data-stu-id="9f073-137">See Also</span></span>  
 [<span data-ttu-id="9f073-138">手順 6: Contoso 3A4 取引先契約の作成</span><span class="sxs-lookup"><span data-stu-id="9f073-138">Step 6: Creating the Contoso 3A4 Trading Partner Agreement</span></span>](../../adapters-and-accelerators/accelerator-rosettanet/step-6-creating-the-contoso-3a4-trading-partner-agreement.md)