...
##  <span data-ttu-id="33546-132"><a name="Custom_Web_Part"></a>カスタム Web パーツに関連する問題</span><span class="sxs-lookup"><span data-stu-id="33546-132"><a name="Custom_Web_Part"></a> Issues Involving Custom Web Parts</span></span>  
...
###  <span data-ttu-id="33546-156"><a name="Issue1"></a>問題 4: 複数の値に基づいて Microsoft Office SharePoint Server で 1 つのレコードを表示するオプションと制限</span><span class="sxs-lookup"><span data-stu-id="33546-156"><a name="Issue1"></a> Issue 4: Limitation with displaying a single record in Microsoft Office SharePoint Server based on multiple values</span></span>  
