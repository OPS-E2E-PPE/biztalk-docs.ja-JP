...
##### [手順 1: Siebel ビジネス コンポーネント操作を WCF Service として公開する](step-1-publish-the-siebel-business-component-operations-as-a-wcf-service.md)
...
##### [手順 3: Siebel からデータを取得するための SharePoint アプリケーションを作成する](step-3-create-a-sharepoint-application-to-retrieve-data-from-siebel.md)
##### [手順 4: SharePoint アプリケーションをテストする](step-4-test-your-sharepoint-application-with-the-siebel-adapter.md)
#### [チュートリアル 2: BizTalk プロジェクトを移行する](tutorial-2-migrating-biztalk-projects-in-siebel.md)
##### [手順 1: vPrev BizTalk プロジェクトを変更する](step-1-modify-the-vprev-biztalk-project-with-the-siebel-adapter.md)
...
##### [手順 3: 移行されたアプリケーションをテストする](step-3-test-the-migrated-application-with-the-siebel-adapter.md)
