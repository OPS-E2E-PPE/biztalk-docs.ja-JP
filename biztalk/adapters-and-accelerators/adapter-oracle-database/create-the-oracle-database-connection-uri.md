...
> [!IMPORTANT]
> - このアプローチでアダプター クライアントがインストールされて、コンピューターの tnsnames.ora ファイルで net サービス名のエントリを追加する必要があります。 Net サービス名のエントリの詳細については、[Oracle データベース アダプターの Oracle クライアントを構成する](../../adapters-and-accelerators/adapter-oracle-database/configure-the-oracle-client-for-the-oracle-database-adapter.md)を参照してください。  
...
|   [NET_SERVICE_NAME]    | hostinfoparams |                                                                                                                                                                            コンピューターの tnsnames.ora ファイルで指定されている net サービス名を[!INCLUDE[adapteroracle_short](../../includes/adapteroracle-short-md.md)]がインストールされています。 Net サービス名と tnsnames.ora の詳細については、[Oracle データベース アダプターの Oracle クライアントを構成する](../../adapters-and-accelerators/adapter-oracle-database/configure-the-oracle-client-for-the-oracle-database-adapter.md)を参照してください。                                                                                                                                                                             |
