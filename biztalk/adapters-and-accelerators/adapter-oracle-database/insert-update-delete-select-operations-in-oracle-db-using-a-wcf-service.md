...
###  <span data-ttu-id="6f09e-165"><a name="BKMK_InsertOperation"></a>挿入操作</span><span class="sxs-lookup"><span data-stu-id="6f09e-165"><a name="BKMK_InsertOperation"></a> Insert Operation</span></span>  
...
##  <span data-ttu-id="6f09e-234"><a name="BKMK_LimitationsInvoking"></a>WCF サービス モデルを使用して基本的な SQL 操作を呼び出すことの制限事項</span><span class="sxs-lookup"><span data-stu-id="6f09e-234"><a name="BKMK_LimitationsInvoking"></a> Limitations of Invoking the Basic SQL Operations by Using the WCF Service Model</span></span>  
