...
### <a name="to-create-the-qryq01txt-file"></a>Qry ^ q01.txt ファイルを作成するには  
...
2. ファイルに保存します**qry ^ q01.txt**で、 \<*ドライブ*:\>\Program Files\Microsoft BizTalk\<バージョン\>HL7\SDK\ のアクセラレータInterrogative チュートリアル フォルダー、およびエディターを閉じます。  
  
   続行する[DSR.txt ファイルの作成](../../adapters-and-accelerators/accelerator-hl7/create-the-dsr-txt-file.md)です。