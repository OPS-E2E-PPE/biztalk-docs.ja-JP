...
---
# <a name="step-3-create-and-deploy-a-trigger-event-message-projecthl7main"></a>手順 3:作成および展開のトリガー イベント (メッセージ) の _hl7_main
...
6. ソリューション エクスプ ローラーで右クリックして**BTAHL7V24Body プロジェクト**、 をクリックし、**デプロイ**します。 成功メッセージが出力ウィンドウに表示を確認します。  
   ...
   続行する[手順 4。作成、受信ポート ADT クエリ メッセージの受け入れの](../../adapters-and-accelerators/accelerator-hl7/step-4-create-the-receive-port-for-accepting-adt-query-messages.md)します。