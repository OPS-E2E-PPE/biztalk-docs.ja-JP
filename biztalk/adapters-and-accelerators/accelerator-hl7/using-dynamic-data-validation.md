...
-   できますを作成するルール デザイン時にビジネス ルール作成ツールのユーザー インターフェイスまたは直接でビジネス ルール言語 (BRL) XML をテキスト エディターでします。  
 ...
 ビジネス ルールとビジネス ルール エンジンに関する詳細については、「ビジネス ルールの開発」を参照してください[!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)]ヘルプ。  
