...
-   [動的データ検証の使用](../../adapters-and-accelerators/accelerator-hl7/using-dynamic-data-validation.md)  
  
-   [監査およびログ イベント用の WMI シンクの作成](../../adapters-and-accelerators/accelerator-hl7/creating-a-wmi-sink-for-auditing-and-logging-events.md)  
