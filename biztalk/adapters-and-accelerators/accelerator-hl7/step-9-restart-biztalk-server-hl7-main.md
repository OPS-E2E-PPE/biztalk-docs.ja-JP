...
1. クリックして**開始**、 をポイント**プログラム**、 をポイント**Microsoft [!INCLUDE[bts2010R2](../../includes/bts2010r2-md.md)]** 、順にクリックします**BizTalk Server 管理**します。  
  
2. Microsoft BizTalk Server 管理コンソールで  **BizTalk Server 管理**、展開**BizTalk グループ**、展開**プラットフォームの設定**、順にクリックします**インスタンスをホスト**します。  
