...
6.  <span data-ttu-id="e5b90-168">コンソール ツリーでクリックして **フィルター**, 、し、次の操作を行います。</span><span class="sxs-lookup"><span data-stu-id="e5b90-168">In the console tree, click **Filters**, and then do the following:</span></span>  
