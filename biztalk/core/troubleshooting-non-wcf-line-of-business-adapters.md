...
-   ブラウジング エージェント: エラーがコンス トラクターにトラップします。 ターゲット マシンは能動的に接続を拒否しました。  
  
-   ランタイム エージェント: エラーがコンス トラクターにトラップします。 ターゲット マシンは能動的に接続を拒否しました。  
...
1.  レジストリを開きに移動*hkey_local_machine \software\microsoft\biztalkadapters*です。  
...
> [!IMPORTANT]
>  追加する、 **StartAgentSleep**レジストリ キーへの影響**すべて**非 WCF LOB アダプター。  
