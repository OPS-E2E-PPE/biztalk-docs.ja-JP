---
title: "計画と Architecture15 |Microsoft ドキュメント"
ms.custom: 
ms.date: 06/08/2017
...
このセクションでは、計画とアーキテクチャの問題を Microsoft BizTalk Adapter for TIBCO Rendezvous の使用の TIBCO Rendezvous を設定するときに発生する可能性がについて説明します。  
