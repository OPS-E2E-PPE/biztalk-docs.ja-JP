...
### <a name="to-remove-bam-alerts"></a><span data-ttu-id="39fc1-104">BAM 警告を削除するには</span><span class="sxs-lookup"><span data-stu-id="39fc1-104">To remove BAM alerts</span></span>  
  
1.  <span data-ttu-id="39fc1-105">次のように、コマンド プロンプトを開きます: をクリックして**開始**、 をクリックして**実行**、型**cmd**、順にクリック**ok**です。</span><span class="sxs-lookup"><span data-stu-id="39fc1-105">Open a command prompt as follows: Click **Start**, click **Run**, type **cmd**, and then click **OK**.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="39fc1-109">参照</span><span class="sxs-lookup"><span data-stu-id="39fc1-109">See Also</span></span>  
 <span data-ttu-id="39fc1-110">[BAM 動的インフラストラクチャの管理](../core/managing-the-bam-dynamic-infrastructure.md) </span><span class="sxs-lookup"><span data-stu-id="39fc1-110">[Managing the BAM Dynamic Infrastructure](../core/managing-the-bam-dynamic-infrastructure.md) </span></span>  
 <span data-ttu-id="39fc1-111">[BAM のセキュリティに関する推奨事項](../core/bam-security-recommendations.md) </span><span class="sxs-lookup"><span data-stu-id="39fc1-111">[BAM Security Recommendations](../core/bam-security-recommendations.md) </span></span>  
 [<span data-ttu-id="39fc1-112">BAM 管理ユーティリティ</span><span class="sxs-lookup"><span data-stu-id="39fc1-112">BAM Management Utility</span></span>](../core/bam-management-utility.md)