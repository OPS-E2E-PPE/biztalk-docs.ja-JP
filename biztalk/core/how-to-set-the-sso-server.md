...
3.  型**ssomanage – server \<SSO サーバー名 >**ここで、  **\<SSO サーバー名 >**ユーザーが接続するシングル サインオン サーバーのコンピューター名を指定します。  
...
3.  型**ssomanage – serverall \<SSO サーバー名 >**ここで、  **\<SSO サーバー名 >**シングル サインオン ユーザーのすべてのメンバーをシングル サインオン サーバーのコンピューター名にはアカウントが指すされます。  
