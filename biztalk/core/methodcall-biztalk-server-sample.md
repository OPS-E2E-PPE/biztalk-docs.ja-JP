...
3.  <span data-ttu-id="79de7-109">数値演算ライブラリ メソッドのいずれか適切な**追加**または**減算**要求された計算を実行し、その結果、XML ドキュメントとしてパッケージ化します。</span><span class="sxs-lookup"><span data-stu-id="79de7-109">The appropriate math library method, either **Add** or **Subtract**, performs the requested calculation and packages the result as an XML document.</span></span>  
...
-   <span data-ttu-id="79de7-124">次のコードを式図形に配置することにより、オーケストレーションをデバッグします。</span><span class="sxs-lookup"><span data-stu-id="79de7-124">Debugging the orchestration by putting the following code in the Expression shape:</span></span>  
    ...
    ```  
     ...
     <span data-ttu-id="79de7-125">次のコードを使用して、結果をイベント ログに書き込むこともできます。</span><span class="sxs-lookup"><span data-stu-id="79de7-125">You can also write the result to the event log by using:</span></span>  
  
    ```  
    System.Diagnostics.EventLog.WriteEntry("MethodCall SDK Sample Debug", System.String.Format("Result = {0}", iResult);  
    ```  
  
## <a name="where-to-find-this-sample"></a><span data-ttu-id="79de7-126">このサンプルの場所</span><span class="sxs-lookup"><span data-stu-id="79de7-126">Where to Find This Sample</span></span>  
 <span data-ttu-id="79de7-127">\<*パスのサンプル*> \Orchestrations\MethodCall\\</span><span class="sxs-lookup"><span data-stu-id="79de7-127">\<*Samples Path*>\Orchestrations\MethodCall\\</span></span>  
  
 <span data-ttu-id="79de7-128">次の表は、このサンプルのファイルとその目的を示しています。</span><span class="sxs-lookup"><span data-stu-id="79de7-128">The following table shows the files in this sample and describes their purpose.</span></span>  
  
|<span data-ttu-id="79de7-129">ファイル</span><span class="sxs-lookup"><span data-stu-id="79de7-129">File(s)</span></span>|<span data-ttu-id="79de7-130">Description</span><span class="sxs-lookup"><span data-stu-id="79de7-130">Description</span></span>|  
|---------------|-----------------|  
|<span data-ttu-id="79de7-131">Cleanup.bat</span><span class="sxs-lookup"><span data-stu-id="79de7-131">Cleanup.bat</span></span>|<span data-ttu-id="79de7-132">アセンブリの展開を解除し、グローバル アセンブリ キャッシュからアセンブリを削除するために使用されます。</span><span class="sxs-lookup"><span data-stu-id="79de7-132">Used to undeploy assemblies and remove them from the global assembly cache.</span></span> <span data-ttu-id="79de7-133">送信ポートと受信ポートが削除されます。</span><span class="sxs-lookup"><span data-stu-id="79de7-133">Removes send and receive ports.</span></span> <span data-ttu-id="79de7-134">必要に応じて、Microsoft インターネット インフォメーション サービス (IIS) の仮想ディレクトリが削除されます。</span><span class="sxs-lookup"><span data-stu-id="79de7-134">Removes Microsoft Internet Information Services (IIS) virtual directories as needed.</span></span>|  
|<span data-ttu-id="79de7-135">Input.xml</span><span class="sxs-lookup"><span data-stu-id="79de7-135">Input.xml</span></span>|<span data-ttu-id="79de7-136">サンプル入力ファイルです。</span><span class="sxs-lookup"><span data-stu-id="79de7-136">Sample input file.</span></span>|  
|<span data-ttu-id="79de7-137">Setup.bat</span><span class="sxs-lookup"><span data-stu-id="79de7-137">Setup.bat</span></span>|<span data-ttu-id="79de7-138">このサンプルをビルドおよび初期化するために使用されます。</span><span class="sxs-lookup"><span data-stu-id="79de7-138">Used to build and initialize this sample.</span></span>|  
|<span data-ttu-id="79de7-139">\MathLibrary フォルダには、次のファイルが含まれます。</span><span class="sxs-lookup"><span data-stu-id="79de7-139">In the \MathLibrary folder:</span></span><br /><br /> <span data-ttu-id="79de7-140">AssemblyInfo.cs、MathHelper.cs、MathLibrary.csproj</span><span class="sxs-lookup"><span data-stu-id="79de7-140">AssemblyInfo.cs, MathHelper.cs, MathLibrary.csproj</span></span>|<span data-ttu-id="79de7-141">このサンプルで使用する数値演算ライブラリのプロジェクト ファイルとソース ファイルです。</span><span class="sxs-lookup"><span data-stu-id="79de7-141">Project and source files for the math library used by this sample.</span></span>|  
|<span data-ttu-id="79de7-142">\MethodCallSample フォルダには、次のファイルが含まれます。</span><span class="sxs-lookup"><span data-stu-id="79de7-142">In the \MethodCallSample folder:</span></span><br /><br /> <span data-ttu-id="79de7-143">InputSchema.xsd、OutputSchema.xsd</span><span class="sxs-lookup"><span data-stu-id="79de7-143">InputSchema.xsd, OutputSchema.xsd</span></span>|<span data-ttu-id="79de7-144">それぞれ、入力 .xml ファイルと出力 .xml ファイルのスキーマです。</span><span class="sxs-lookup"><span data-stu-id="79de7-144">Schemas for the input and output .xml files, respectively.</span></span>|  
|<span data-ttu-id="79de7-145">\MethodCallSample フォルダには、次のファイルが含まれます。</span><span class="sxs-lookup"><span data-stu-id="79de7-145">In the \MethodCallSample folder:</span></span><br /><br /> <span data-ttu-id="79de7-146">MethodCallSample.btproj、MethodCallSample.sln</span><span class="sxs-lookup"><span data-stu-id="79de7-146">MethodCallSample.btproj, MethodCallSample.sln</span></span>|<span data-ttu-id="79de7-147">このサンプルのプロジェクト ファイルとソリューション ファイルです。</span><span class="sxs-lookup"><span data-stu-id="79de7-147">Project and solution files for this sample.</span></span>|  
|<span data-ttu-id="79de7-148">\MethodCallSample フォルダには、次のファイルが含まれます。</span><span class="sxs-lookup"><span data-stu-id="79de7-148">In the \MethodCallSample folder:</span></span><br /><br /> <span data-ttu-id="79de7-149">MethodCallSampleBinding.xml</span><span class="sxs-lookup"><span data-stu-id="79de7-149">MethodCallSampleBinding.xml</span></span>|<span data-ttu-id="79de7-150">ポートのバインドなど、自動化されたセットアップに使用されます。</span><span class="sxs-lookup"><span data-stu-id="79de7-150">Used for automated setup such as port binding.</span></span>|  
|<span data-ttu-id="79de7-151">\MethodCallSample フォルダには、次のファイルが含まれます。</span><span class="sxs-lookup"><span data-stu-id="79de7-151">In the \MethodCallSample folder:</span></span><br /><br /> <span data-ttu-id="79de7-152">MethodCallService.odx</span><span class="sxs-lookup"><span data-stu-id="79de7-152">MethodCallService.odx</span></span>|<span data-ttu-id="79de7-153">数値演算ライブラリを呼び出し、要求された計算を実行する [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] オーケストレーションです。</span><span class="sxs-lookup"><span data-stu-id="79de7-153">[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] orchestration that calls the math library to perform the requested calculation.</span></span>|  
  
## <a name="building-and-initializing-this-sample"></a><span data-ttu-id="79de7-154">このサンプルのビルドと初期化</span><span class="sxs-lookup"><span data-stu-id="79de7-154">Building and Initializing This Sample</span></span>  
  
#### <a name="to-build-and-initialize-the-methodcall-sample"></a><span data-ttu-id="79de7-155">MethodCall サンプルをビルドおよび初期化するには</span><span class="sxs-lookup"><span data-stu-id="79de7-155">To build and initialize the MethodCall sample</span></span>  
