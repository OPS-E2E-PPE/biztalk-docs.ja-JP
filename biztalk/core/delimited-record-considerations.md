...
-   [区切られたレコードのタグ処理](../core/tag-handling-in-delimited-records.md)  
  
-   [子の順序に関する注意事項](../core/child-order-considerations.md)  
  
-   [区切り記号の保存および非表示](../core/delimiter-preservation-and-suppression.md)