...
---
# <a name="restart-biztalk-services-or-shut-down-the-biztalk-server"></a><span data-ttu-id="a9062-103">、BizTalk サービスを再起動またはシャット ダウン、BizTalk Server</span><span class="sxs-lookup"><span data-stu-id="a9062-103">Restart BizTalk services, or shut down the BizTalk Server</span></span>

<span data-ttu-id="a9062-104">次の表に、ユーザーが開始、停止、一時停止、再開、または再起動できる BizTalk Server サービスを示します。</span><span class="sxs-lookup"><span data-stu-id="a9062-104">The following table lists the BizTalk Server services that you can start, stop, pause, resume, or restart:</span></span>  
  
|<span data-ttu-id="a9062-105">名前</span><span class="sxs-lookup"><span data-stu-id="a9062-105">Name</span></span>|<span data-ttu-id="a9062-106">説明</span><span class="sxs-lookup"><span data-stu-id="a9062-106">Description</span></span>|<span data-ttu-id="a9062-107">スタートアップの種類</span><span class="sxs-lookup"><span data-stu-id="a9062-107">Startup Type</span></span>|<span data-ttu-id="a9062-108">依存関係</span><span class="sxs-lookup"><span data-stu-id="a9062-108">Dependencies</span></span>|  
|----------|-----------------|------------------|------------------|  
|<span data-ttu-id="a9062-109">BizTalk Service BizTalk Group:  *\<[biztalkserverapplication]\>*</span><span class="sxs-lookup"><span data-stu-id="a9062-109">BizTalk Service BizTalk Group: *\<BizTalkServerApplication\>*</span></span>|<span data-ttu-id="a9062-110">BizTalk Server アプリケーション サービスを提供します。</span><span class="sxs-lookup"><span data-stu-id="a9062-110">Provides the BizTalk Server application service.</span></span>|<span data-ttu-id="a9062-111">自動</span><span class="sxs-lookup"><span data-stu-id="a9062-111">Automatic</span></span>|<span data-ttu-id="a9062-112">エンタープライズ シングル サインオン (SSO) サービス</span><span class="sxs-lookup"><span data-stu-id="a9062-112">-   Enterprise Single Sign-On (SSO) Service</span></span><br /><span data-ttu-id="a9062-113">イベント ログ</span><span class="sxs-lookup"><span data-stu-id="a9062-113">-   Event Log</span></span><br /><span data-ttu-id="a9062-114">-リモート プロシージャ コール (RPC)</span><span class="sxs-lookup"><span data-stu-id="a9062-114">-   Remote Procedure Call (RPC)</span></span>|  
|<span data-ttu-id="a9062-115">エンタープライズ シングル サインオン サービス</span><span class="sxs-lookup"><span data-stu-id="a9062-115">Enterprise Single Sign-On Service</span></span>|<span data-ttu-id="a9062-116">エンタープライズ アプリケーションにシングル サインオン サービスを提供します。</span><span class="sxs-lookup"><span data-stu-id="a9062-116">Provides single sign-on services to enterprise applications.</span></span>|<span data-ttu-id="a9062-117">自動</span><span class="sxs-lookup"><span data-stu-id="a9062-117">Automatic</span></span>|<span data-ttu-id="a9062-118">ローカルにインストールされる SQL Server の場合</span><span class="sxs-lookup"><span data-stu-id="a9062-118">With SQL Server installed locally:</span></span><br /><br /> <span data-ttu-id="a9062-119">-COM + システム アプリケーション</span><span class="sxs-lookup"><span data-stu-id="a9062-119">-   COM+ System Application</span></span><br /><span data-ttu-id="a9062-120">-リモート プロシージャ コール (RPC)</span><span class="sxs-lookup"><span data-stu-id="a9062-120">-   Remote Procedure Call (RPC)</span></span><br /><span data-ttu-id="a9062-121">SQL Server (MSSQLSERVER)</span><span class="sxs-lookup"><span data-stu-id="a9062-121">-   SQL Server (MSSQLSERVER)</span></span><br /><br /> <span data-ttu-id="a9062-122">リモートにインストールされる SQL Server の場合</span><span class="sxs-lookup"><span data-stu-id="a9062-122">With SQL Server installed remotely:</span></span><br /><br /> <span data-ttu-id="a9062-123">-COM + システム アプリケーション</span><span class="sxs-lookup"><span data-stu-id="a9062-123">-   COM+ System Application</span></span><br /><span data-ttu-id="a9062-124">-リモート プロシージャ コール (RPC) なし</span><span class="sxs-lookup"><span data-stu-id="a9062-124">-   Remote Procedure Call (RPC)None</span></span>|  
|<span data-ttu-id="a9062-125">ルール エンジン更新サービス</span><span class="sxs-lookup"><span data-stu-id="a9062-125">Rule Engine Update Service</span></span>|<span data-ttu-id="a9062-126">ポリシーの展開または展開解除について、ユーザーに通知します。</span><span class="sxs-lookup"><span data-stu-id="a9062-126">Notifies users about the deployment or undeployment of policies.</span></span>|<span data-ttu-id="a9062-127">Automatic</span><span class="sxs-lookup"><span data-stu-id="a9062-127">Automatic</span></span>|<span data-ttu-id="a9062-128">なし</span><span class="sxs-lookup"><span data-stu-id="a9062-128">None</span></span>|  
  
 
## <a name="start-stop-pause-resume-or-restart-a-biztalk-server-service"></a><span data-ttu-id="a9062-129">開始、停止、一時停止、再開、または BizTalk Server サービスを再起動します。</span><span class="sxs-lookup"><span data-stu-id="a9062-129">Start, stop, pause, resume, or restart a BizTalk Server service</span></span>  
 <span data-ttu-id="a9062-130">ことができます開始、停止、一時停止、再開、または Services.msc、またはコマンド プロンプトを使用して、BizTalk Server サービスを再起動します。</span><span class="sxs-lookup"><span data-stu-id="a9062-130">You can start, stop, pause, resume, or restart a BizTalk Server service by using Services.msc, or using the command prompt.</span></span>

### <a name="prerequisites"></a><span data-ttu-id="a9062-131">前提条件</span><span class="sxs-lookup"><span data-stu-id="a9062-131">Prerequisites</span></span>  
...
2.  <span data-ttu-id="a9062-141">次のいずれかを入力、 *ServiceName*開始、停止、一時停止、または再開する BizTalk Server サービスの名前を指定します。</span><span class="sxs-lookup"><span data-stu-id="a9062-141">Type one of the following, where *ServiceName* is the name of the BizTalk Server service you want to start, stop, pause, or resume:</span></span>  
    ...
    -   <span data-ttu-id="a9062-146">サービスを一時停止するには、次のように入力します。</span><span class="sxs-lookup"><span data-stu-id="a9062-146">To pause a service, type:</span></span>  
...
3. <span data-ttu-id="a9062-169">[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] サービスをシャットダウンします。</span><span class="sxs-lookup"><span data-stu-id="a9062-169">Shut down [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] services.</span></span> <span data-ttu-id="a9062-170">参照してください**開始、停止、一時停止、再開、または BizTalk Server サービスを再起動する方法**(」を参照)。</span><span class="sxs-lookup"><span data-stu-id="a9062-170">See **How to Start, Stop, Pause, Resume, or Restart BizTalk Server Services** (in this topic).</span></span>
...
## <a name="see-also"></a><span data-ttu-id="a9062-182">参照</span><span class="sxs-lookup"><span data-stu-id="a9062-182">See Also</span></span>  
