...
|bts-legacy-properties.xsd|BizTalk がこのスキーマをアップグレードするために使用[!INCLUDE[btsBizTalkServer2002](../includes/btsbiztalkserver2002-md.md)]アプリケーションを BizTalk Server アプリケーションです。|  
