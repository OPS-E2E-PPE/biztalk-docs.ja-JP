...
1.  <span data-ttu-id="fabba-106">HTTP 受信アダプター (BTSHTTPReceive.dll) から **\<BizTalk2010 > \HttpReceive >**シングル サインオン (SSO) プロジェクトを含むフォルダーに (たとえば、 **< Adapter_install > \biztalk2010\SSO\mySSODemo**)。</span><span class="sxs-lookup"><span data-stu-id="fabba-106">Copy the HTTP receive adapter (BTSHTTPReceive.dll) from **\<BizTalk2010>\HttpReceive>** to the folder containing your Single Sign-On (SSO) project (for example, **<Adapter_install>\biztalk2010\SSO\mySSODemo**).</span></span>  
    ...
    2.  <span data-ttu-id="fabba-108"><BizTalk_install>\HttpReceive に移動し、これを SSO プロジェクト</span><span class="sxs-lookup"><span data-stu-id="fabba-108">Browse to and copy <BizTalk_install>\HttpReceive to the folder containing your SSO project, for example,</span></span>  
  
         <span data-ttu-id="fabba-109">(<Adapter_install>\biztalk2010\SSO\mySSODemo\BTSHTTPReceive.dll など) を格納しているフォルダーにコピーします。</span><span class="sxs-lookup"><span data-stu-id="fabba-109"><Adapter_install>\biztalk2010\SSO\mySSODemo\BTSHTTPReceive.dll.</span></span>  
  
    3.  <span data-ttu-id="fabba-110">MySSODemo Web サービス拡張機能の状態を設定**許可**です。</span><span class="sxs-lookup"><span data-stu-id="fabba-110">Set status of mySSODemo Web service extension to **Allowed**.</span></span>  
  
2.  <span data-ttu-id="fabba-111">IIS を再起動してすべての変更が反映されるようにします。</span><span class="sxs-lookup"><span data-stu-id="fabba-111">Restart IIS to ensure that all changes are in effect.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="fabba-112">参照</span><span class="sxs-lookup"><span data-stu-id="fabba-112">See Also</span></span>  
 [<span data-ttu-id="fabba-113">アダプターのセキュリティ</span><span class="sxs-lookup"><span data-stu-id="fabba-113">Security in the adapter</span></span>](../core/security-in-biztalk-adapter-for-jd-edwards-oneworld.md)