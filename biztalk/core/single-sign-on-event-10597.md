...
|メッセージ テキスト|SSO 管理者アカウント名を変更するには、クライアント ユーザーが新しい SSO 管理者アカウントのメンバーである必要があります。%r<br /><br /> クライアント ユーザー: %1 %r<br /><br /> 新しい SSO 管理者: %2|  
  
## <a name="explanation"></a>説明  
 SSO 管理者アカウント名を変更するには、クライアント ユーザーが新しい SSO 管理者アカウントのメンバーである必要があります。  
  
## <a name="user-action"></a>ユーザーの操作  
 SSO 管理者アカウント名を変更するには、新しい SSO 管理者アカウントのメンバーである必要があります。