...
1.  新しいメッセージの公開を無効にします。  
     ...
     メッセージ ボックス データベースを削除する前に、新しいメッセージの公開を無効にする必要があります。 新しいメッセージの公開を無効にする方法については、[新しいメッセージの公開を無効にする方法](../core/how-to-disable-new-message-publication.md)を参照してください。  
...
4.  削除したメッセージ ボックス データベースへのキャッシュされた接続を含むホスト インスタンスを再起動します。  
     ...
     ホスト インスタンスにランタイム エンジンからキャッシュされたデータベースへの接続がある場合、データベースを SQL Server から物理的に削除する前に、ホスト インスタンスを再起動する必要があります。 ホスト インスタンスの開始方法の詳細については、[ホスト インスタンスを開始する方法](../core/how-to-start-a-host-instance.md)を参照してください。  
  
5.  データベースにアクセスする、実行中のホスト インスタンスをすべて停止します。 実行中のホスト インスタンスを停止する方法の詳細については、[ホスト インスタンスを停止する方法](../core/how-to-stop-a-host-instance.md)を参照してください。  
