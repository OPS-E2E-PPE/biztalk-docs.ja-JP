...
---
# <a name="recovering-a-computer-running-biztalk-server"></a>BizTalk Server を実行しているコンピュータの復旧
...
-   [エンタープライズ シングル サインオンを回復する方法](../core/how-to-recover-enterprise-single-sign-on.md)  
