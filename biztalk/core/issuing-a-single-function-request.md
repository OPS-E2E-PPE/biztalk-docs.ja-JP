...
---
# <a name="issuing-a-single-function-request"></a><span data-ttu-id="f7f92-102">単一関数の要求の発行</span><span class="sxs-lookup"><span data-stu-id="f7f92-102">Issuing a Single-Function Request</span></span>
<span data-ttu-id="f7f92-103">次の GetEffectiveAddress の例は JD Edwards EnterpriseOne への単一関数の呼び出しであり、この要求の結果は標準の応答ドキュメントです。</span><span class="sxs-lookup"><span data-stu-id="f7f92-103">The following example, GetEffectiveAddress, is a single-function call to JD Edwards EnterpriseOne, and the result of this request is a standard response document.</span></span> <span data-ttu-id="f7f92-104">単一関数の要求では、XML オブジェクト内の 1 つの callMethod だけを指定します。</span><span class="sxs-lookup"><span data-stu-id="f7f92-104">In a single-function request, only one callMethod within the XML object is specified.</span></span>  
  
## <a name="example-executing-a-business-function-with-a-single-function-call"></a><span data-ttu-id="f7f92-105">例: 単一関数の呼び出しによるビジネス関数の実行</span><span class="sxs-lookup"><span data-stu-id="f7f92-105">Example: Executing a Business Function with a Single-Function Call</span></span>  
 <span data-ttu-id="f7f92-106">次のコードは、GetEffectiveAddress 要求ドキュメントのサンプルです。</span><span class="sxs-lookup"><span data-stu-id="f7f92-106">The following is a sample GetEffectiveAddress request document.</span></span> <span data-ttu-id="f7f92-107">これは、BizTalk Server で、生成された項目を追加する際に作成される XSD から、XML インスタンスとして生成されます。</span><span class="sxs-lookup"><span data-stu-id="f7f92-107">It is generated by BizTalk Server as an XML instance from the XSD that is created when you add generated items.</span></span> <span data-ttu-id="f7f92-108">この要求ドキュメントのサンプルは、送信ポート構成の ATTRIBUTE_STYLE スキーマ スタイルを使用して生成されています。</span><span class="sxs-lookup"><span data-stu-id="f7f92-108">This sample request document was generated using the ATTRIBUTE_STYLE schema style in the send port configuration.</span></span>  
  
 <span data-ttu-id="f7f92-109">**要求 XML のサンプル**</span><span class="sxs-lookup"><span data-stu-id="f7f92-109">**Request XML Sample**</span></span>  
...
```  
 ...
 <span data-ttu-id="f7f92-110">J. d. から返される GetEffectiveAddress 応答の例を次に示します</span><span class="sxs-lookup"><span data-stu-id="f7f92-110">The following is a sample GetEffectiveAddress response returned by J.D.</span></span> <span data-ttu-id="f7f92-111">Edwards EnterpriseOne は、GetEffectiveAddress 要求への応答として。</span><span class="sxs-lookup"><span data-stu-id="f7f92-111">Edwards EnterpriseOne as a reply to the GetEffectiveAddress request.</span></span>  
  
 <span data-ttu-id="f7f92-112">**応答 XML のサンプル**</span><span class="sxs-lookup"><span data-stu-id="f7f92-112">**Response XML Sample**</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="f7f92-113">参照</span><span class="sxs-lookup"><span data-stu-id="f7f92-113">See Also</span></span>  
 [<span data-ttu-id="f7f92-114">付録 a: サンプル ファイル</span><span class="sxs-lookup"><span data-stu-id="f7f92-114">Appendix A: Sample Files</span></span>](../core/appendix-a-sample-files.md)