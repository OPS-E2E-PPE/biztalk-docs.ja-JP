...
---
# <a name="issuing-a-single-function-request"></a><span data-ttu-id="84a76-102">単一関数の要求の発行</span><span class="sxs-lookup"><span data-stu-id="84a76-102">Issuing a Single-Function Request</span></span>
<span data-ttu-id="84a76-103">次の例では、GetEffectiveAddress、JD Edwards EnterpriseOne では、単一関数呼び出しであるし、この要求の結果は標準の応答ドキュメント。</span><span class="sxs-lookup"><span data-stu-id="84a76-103">The following example, GetEffectiveAddress, is a single-function call to JD Edwards EnterpriseOne, and the result of this request is a standard response document.</span></span> <span data-ttu-id="84a76-104">単一関数の要求では、XML オブジェクト内で 1 つだけの callMethod を指定します。</span><span class="sxs-lookup"><span data-stu-id="84a76-104">In a single-function request, only one callMethod within the XML object is specified.</span></span>  
  
## <a name="example-executing-a-business-function-with-a-single-function-call"></a><span data-ttu-id="84a76-105">例:単一関数の呼び出しによるビジネス関数の実行</span><span class="sxs-lookup"><span data-stu-id="84a76-105">Example: Executing a Business Function with a Single-Function Call</span></span>  
 <span data-ttu-id="84a76-106">GetEffectiveAddress 要求ドキュメントのサンプルを次に示します。</span><span class="sxs-lookup"><span data-stu-id="84a76-106">The following is a sample GetEffectiveAddress request document.</span></span> <span data-ttu-id="84a76-107">BizTalk Server によって生成された項目を追加するときに作成される XSD から XML インスタンスとして生成されます。</span><span class="sxs-lookup"><span data-stu-id="84a76-107">It is generated by BizTalk Server as an XML instance from the XSD that is created when you add generated items.</span></span> <span data-ttu-id="84a76-108">この要求ドキュメントのサンプルは、送信ポートの構成の ATTRIBUTE_STYLE スキーマ スタイルを使用して生成されました。</span><span class="sxs-lookup"><span data-stu-id="84a76-108">This sample request document was generated using the ATTRIBUTE_STYLE schema style in the send port configuration.</span></span>  
  
 <span data-ttu-id="84a76-109">**要求 XML のサンプル**</span><span class="sxs-lookup"><span data-stu-id="84a76-109">**Request XML Sample**</span></span>  
...
```  
 ...
 <span data-ttu-id="84a76-110">次は、j. d. によって返される GetEffectiveAddress 応答のサンプル</span><span class="sxs-lookup"><span data-stu-id="84a76-110">The following is a sample GetEffectiveAddress response returned by J.D.</span></span> <span data-ttu-id="84a76-111">Edwards EnterpriseOne は、GetEffectiveAddress 要求への応答として。</span><span class="sxs-lookup"><span data-stu-id="84a76-111">Edwards EnterpriseOne as a reply to the GetEffectiveAddress request.</span></span>  
  
 <span data-ttu-id="84a76-112">**応答 XML のサンプル**</span><span class="sxs-lookup"><span data-stu-id="84a76-112">**Response XML Sample**</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="84a76-113">参照</span><span class="sxs-lookup"><span data-stu-id="84a76-113">See Also</span></span>  
 [<span data-ttu-id="84a76-114">付録 a:サンプル ファイル</span><span class="sxs-lookup"><span data-stu-id="84a76-114">Appendix A: Sample Files</span></span>](../core/appendix-a-sample-files.md)