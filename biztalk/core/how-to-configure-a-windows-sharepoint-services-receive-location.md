...
1. 受信ポートが正しく構成されていることを確認してください。 作成して、受信ポートを構成する方法については、[受信ポートを作成する方法](../core/how-to-create-a-receive-port.md)を参照してください。  
