...
---
# <a name="to-enable-status-reporting-run-39biztalk-server-configuration39-and-configure-edi-as2-status-reporting-feature"></a>状態レポート、実行 &#39; を有効にするにはBizTalk Server の構成 &#39;EDI、AS2 状態レポート機能の構成
## <a name="details"></a>詳細  
