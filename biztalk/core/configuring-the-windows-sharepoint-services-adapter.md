...
---
# <a name="configuring-the-windows-sharepoint-services-adapter"></a>Windows SharePoint Services アダプターを構成します。
このセクションのトピックでは、Windows SharePoint Services アダプタを構成する方法について説明します。  
...
-   [サービス コンテキスト プロパティの Windows Sharepoint を使用する送信ポートを構成する方法](../core/configure-send-ports-using-sharepoint-context-properties-in-biztalk-server.md)  
...
-   [Windows SharePoint Services 4.0 のサポート](../core/windows-sharepoint-services-4-0-support.md)  
