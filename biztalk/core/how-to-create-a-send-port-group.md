...
3.  右クリック**送信ポート グループ**、 をポイント**新規**、クリックして**送信ポート グループ**です。  
  
4.  **名前**ボックスで、送信ポート グループの名前を入力します。  
  
5.  **送信ポート**、下にあるドロップダウン リストをクリックして**名前**、送信ポート グループに追加する送信ポート をクリックします。 グループに追加する送信ポートごとにこの手順を繰り返します。 新しい送信ポートを作成し、追加して、クリックして**\<新しいポートを送信しています.\>** し、指示に従って、[送信ポートを作成する方法](../core/how-to-create-a-send-port2.md)です。  
  
6.  送信ポートの送信ポート グループに追加したらをクリックして**OK**です。  
