...
-   サンプルをダウンロードする SDK「を相互に関連付けるメッセージとオーケストレーション インスタンスの」から[http://go.microsoft.com/fwlink/?LinkId=73703](http://go.microsoft.com/fwlink/?LinkId=73703)です。  
  
-   SDK サンプル「パラレルなコンボイ」をダウンロード[http://go.microsoft.com/fwlink/?LinkId=73703](http://go.microsoft.com/fwlink/?LinkId=73703)です。  
