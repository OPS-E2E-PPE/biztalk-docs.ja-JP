...
---
# <a name="transform-inboundtransforms-node"></a>Transform (InboundTransforms ノード)
バインド ファイルの InboundTransforms ノードの Transform ノードには、バインド ファイルと共にエクスポートされる BizTalk Server マップに関する特定の情報が含まれます。  
