...
|                                                  リソース アセンブリをポイントする                                                   |                                           **SetupResourceAssembly**                                           |                                                                                                                                                                                              プロジェクトと共に、リソース ファイルを含めます。 [!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)]を使用してビルドする場合、リソース アセンブリは **ProjectName.ResourceName**の形式で指定する必要があります。                                                                                                                                                                                               |
