...
-   BizTalk Server データベースに対するアイテムの追加および削除の方法  
  
-   ローカル ファイル システムに対するアイテムのコピーおよび削除の方法  
  
-   Windows レジストリに対するアイテム (.NET アセンブリおよび COM コンポーネント) の追加または削除の方法  
  
-   グローバル アセンブリ キャッシュに対するアイテム (BizTalk アセンブリおよび .NET アセンブリ) のインストールまたはアンインストールの方法  
  
-   ローカル証明書ストアへの証明書追加の方法  
