...
---
# <a name="invalid-as2-from-name-encountered-during-processing"></a>無効な AS2 の処理中に検出名から
## <a name="details"></a>詳細  
...
|  メッセージ テキスト   |            無効な AS2 の処理中に検出名から。  値: {0}            |
...
## <a name="user-action"></a>ユーザーの操作  
 このエラーを解決することを確認、AS2 の受信または送信メッセージのメッセージ ヘッダーから、AS2 RFC 4130 のセクション 6.2 の仕様に準拠し、メッセージを再送信します。