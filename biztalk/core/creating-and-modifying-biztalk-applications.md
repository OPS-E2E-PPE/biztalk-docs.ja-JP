...
-   [アプリケーションを構成する方法](../core/how-to-configure-an-application.md)  
  
-   [アプリケーションの名前を変更する方法](../core/how-to-change-the-name-of-an-application.md)  
  
-   [成果物を追加または作成する方法](../core/how-to-create-or-add-an-artifact.md)  
  
-   [Readme ファイルにリンクする方法](../core/how-to-link-to-a-readme-file.md)  
  
-   [アプリケーションを 64 ビット アイテムを追加する方法](../core/how-to-add-a-64-bit-artifact-to-an-application.md)  
  
-   [既定のアプリケーションを変更する方法](../core/how-to-change-the-default-application.md)  
  
-   [別のアプリケーションへの参照を追加する方法](../core/how-to-add-a-reference-to-another-application.md)  
  
-   [アプリケーションの参照を表示する方法](../core/how-to-view-the-references-of-an-application.md)  
  
-   [別のアプリケーションへの参照を削除する方法](../core/how-to-remove-a-reference-to-another-application.md)  
  
-   [別のアプリケーションにアイテムを移動する方法](../core/how-to-move-an-artifact-to-a-different-application.md)  
