...
-   [受信スキーマと、イベントを処理します。](../core/using-tibco-rendezvous-receive-ports-from-biztalk-server.md) 
  
-   [メッセージ マッピング](../core/message-mapping-in-tibco-rendezvous.md)  
  
-   [データ型のマッピング](../core/data-type-mapping-for-receive-handlers-in-tibco-rendezvous.md)  
