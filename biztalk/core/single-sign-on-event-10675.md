...
---
# <a name="single-sign-on-event-10675"></a>シングル サインオン: イベント 10675
## <a name="details"></a>詳細  
...
|イベント ソース|ENTSSO|  
|コンポーネント|N\A|  
|シンボル名|SSO_INFO_WINDOWS_PASSWORD_SET|  
|メッセージ テキスト|Windows パスワードが SSO データベース内で正常に更新されました。%r<br /><br /> 追跡 ID: %1 %r<br /><br /> Windows アカウント: %2 %r<br /><br /> アプリケーション名: %3 %r<br /><br /> 外部アカウント: %4|  
