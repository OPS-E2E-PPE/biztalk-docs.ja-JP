...
-   [アクティビティ ノードと ActivityID ノード](../core/activity-and-activityid-nodes.md)  
  
-   [Continuation ノードと ContinuationID ノード](../core/continuation-and-continuationid-nodes.md)  
  
-   [リレーションシップ ノード](../core/relationship-nodes.md)  
  
-   [ビジネス イベント ノード](../core/business-event-nodes.md)  
  
-   [データ項目ノード](../core/data-item-nodes.md)  
  
-   [ドキュメント参照 URL ノード](../core/document-reference-url-nodes.md)