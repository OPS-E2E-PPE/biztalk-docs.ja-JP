...
-   AK304 は、データ セグメントのエラーに対応するエラー コードです。 AK304 は省略可能です。ただし、識別されたセグメントにエラーが存在する場合は、必須です。 AK304 のエラー コードの一覧は、[X12 997 受信確認エラー コード](../core/x12-997-acknowledgment-error-codes.md)を参照してください。  
...
-   AK403 は必須です。識別された要素のエラーを報告します。 AK403 のエラー コードの一覧は、[X12 997 受信確認エラー コード](../core/x12-997-acknowledgment-error-codes.md)を参照してください。  
...
-   AK501 は、識別されたトランザクション セットが受理されるか、拒否されるかを示します。 AK501 のエラー コードの一覧は、[X12 997 受信確認エラー コード](../core/x12-997-acknowledgment-error-codes.md)を参照してください。  
  
-   AK502 ～ AK506 は、エラーの性質を示します。 AK501 のエラー コードの一覧は、[X12 997 受信確認エラー コード](../core/x12-997-acknowledgment-error-codes.md)を参照してください。  
...
-   AK901 は必須です。AK1 で識別された機能グループが受理されるか、拒否されるかを示します。 AK901 のエラー コードの一覧は、[X12 997 受信確認エラー コード](../core/x12-997-acknowledgment-error-codes.md)を参照してください。  
...
-   AK905 ～ AK909 は、識別された機能グループで検出された 1 ～ 5 個のエラーを示します。 AK905 ~ AK909 のエラー コードの一覧は、[X12 997 受信確認エラー コード](../core/x12-997-acknowledgment-error-codes.md)を参照してください。  
