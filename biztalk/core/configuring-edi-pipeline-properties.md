...
|UseIsa11AsRepetitionSeparator|繰り返し区切り文字として、標準識別子ではなく ISA11 が使用されることを指定します。 **注:** このプロパティは、X12 処理でのみ使用され、EDIFACT には使用されません。|False (既定値)<br /><br /> True|EdiReceive - 逆アセンブル<br /><br /> AS2EdiReceive - 逆アセンブル|  
