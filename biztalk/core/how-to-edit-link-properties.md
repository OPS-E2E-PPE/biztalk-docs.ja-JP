...
- **ラベル**プロパティ リンクの簡単な説明し、はテーブルドリブン ループで特に便利です。 については、**ラベル**プロパティを参照してください[既存のリンクを管理する方法](../core/how-to-manage-existing-links.md)します。  
  
- **ソース リンク**プロパティは、リンクが要素のテキスト値または要素の名前を表すかどうかを決定します。  
