...
|メッセージ テキスト|このアダプターのパスワード同期フラグは、パスワード同期を許可し、グローバル フラグと一致している必要があります。 アダプター フラグとグローバル フラグを確認してください。%r<br /><br /> アダプタ: %1|  
...
-   SSO 管理 MMC スナップインを使用して (システム & #124 です。プロパティ & #124 です。オプション) またはコマンド ライン ツール`ssomanage –enable winsync/extsync`グローバル フラグを有効にします。  
