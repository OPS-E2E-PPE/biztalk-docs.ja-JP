...
---
# <a name="types-of-edi-and-as2-status-reports"></a>EDI および AS2 状態レポートの種類
このセクションのトピックに表示できる EDI および AS2 状態レポートのさまざまな種類の説明、**グループ ハブ**のページ、[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]管理コンソールです。  
