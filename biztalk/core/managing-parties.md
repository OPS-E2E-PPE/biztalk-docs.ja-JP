...
2. **全般**ページで、次の操作を行います。  
   ...
   |                                **追加のプロパティ – 名前/値**                                 |                                                                                                                                                パーティに関する任意の情報を格納する、名前と値の組み合わせを入力します。 名前と値の組み合わせは、必要な数だけ追加できます。 **注**: 名前と値のペアは、処理、BizTalk Server で使用されません。 このデータは情報目的のみ。                                                                                                                                                 |
   |                                               **削除**                                                |                                                                                                                                                                                                                                                    選択した名前と値のペアを削除します。                                                                                                                                                                                                                                                     |
...
5. 選択**適用**、プロパティを受け入れるか選択する**OK**構成設定を完了します。 どちらの操作を行った場合も、設定が有効になります。  
...
4. 選択**適用**、プロパティを受け入れるか選択する**OK**構成設定を完了します。 どちらの操作では、設定を検証します。  
