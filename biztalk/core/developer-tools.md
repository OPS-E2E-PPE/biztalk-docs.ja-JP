...
Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] には、BizTalk アプリケーションのさまざまな要素を設計、準備、ビルドするための BizTalk プロジェクト システム設計環境が用意されています。  
 ...
 このセクションの内容は、[!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)] に関する知識があることを前提としています。 [!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)] について学習する場合は、[!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)] のドキュメントを参照してください。 このセクションの内容は、BizTalk プロジェクト システムに焦点を当てています。  
  
## <a name="in-this-section"></a>このセクションの内容  
  
-   [BizTalk プロジェクト システムについて](../core/about-the-biztalk-project-system.md)  
