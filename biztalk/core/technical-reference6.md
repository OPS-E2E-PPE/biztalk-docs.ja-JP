---
title: "技術的な Reference6 |Microsoft ドキュメント"
ms.custom: 
ms.date: 06/08/2017
...
---
# <a name="technical-reference"></a>テクニカル リファレンス
このセクションでは、Microsoft BizTalk Adapter for JD Edwards EnterpriseOne に関するテクニカル リファレンス情報を提供します。  
