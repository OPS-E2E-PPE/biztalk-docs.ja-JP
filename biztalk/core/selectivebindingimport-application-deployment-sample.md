...
1. 実行**から Build.Bat、 *\<サンプル パス\>* \Application Deployment\CreateApp**ディレクトリ。 これで、次のファイルを作成、 *\<サンプル パス\>* \Application Deployment\CreateApp\Dlls フォルダー。Schemas.dll、Maps.dll、および Orchestrations.dll です。  
