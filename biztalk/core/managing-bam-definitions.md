...
-   [BAM アクティビティを削除する方法](../core/how-to-remove-bam-activities.md)  
  
-   [BAM ビューを一覧表示する方法](../core/how-to-list-bam-views.md)  
  
-   [BAM ビューを削除する方法](../core/how-to-remove-bam-views.md)  
...
-   [BAM アイテムを更新する方法](../core/how-to-update-bam-artifacts.md)  
  
-   [展開済みのアイテムを削除する方法](../core/how-to-remove-deployed-artifacts.md)  
