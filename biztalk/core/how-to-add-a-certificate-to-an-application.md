...
2.  次の表に示すように、適切な値を置き換えて、次のコマンドを入力します。  
    ...
    |パラメーター|値|  
    |---------------|-----------|  
    |**/ApplicationName**|証明書を追加する BizTalk アプリケーションの名前。 アプリケーション名が指定されなかった場合、グループの既定の BizTalk アプリケーションが使用されます。 名前には、スペースが含まれている場合は、二重引用符 (") で囲む必要があります。|  
    ...
    |**/拇印**|証明書の拇印プロパティ (、*拇印*は、データのダイジェスト)。 この値は、二重引用符 (") で囲む必要があります。|  
