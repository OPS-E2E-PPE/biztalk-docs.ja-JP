...
-   [側開始 SSO のホストの要件を構成する方法](../core/how-to-configure-requirements-for-host-initiated-sso.md)  
  
-   [側開始 SSO を有効にし、ホストを無効にする方法](../core/how-to-enable-and-disable-host-initiated-sso.md)  
