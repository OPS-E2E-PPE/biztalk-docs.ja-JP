...
## <a name="next-steps"></a>次の手順  
 パートナー組織のパーティとビジネス プロファイルを構成する (**Fabrikam**)」の説明に従って、[手順 4: パーティとビジネス プロファイル、取引先パートナーを構成](../core/step-4-configure-a-party-and-business-profile-for-your-trading-partner1.md)します。  
