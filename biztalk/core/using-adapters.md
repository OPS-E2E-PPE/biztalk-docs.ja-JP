...
-   [BizTalk Server のアダプター](../core/adapters-in-biztalk-server.md)  
  
-   [動的送信ポート ハンドラーは構成可能](../core/dynamic-send-port-handler-is-configurable.md)  
...
-   [ファイル アダプター](../core/file-adapter.md)  
  
-   [FTP アダプター](../core/ftp-adapter.md)  

- [ロジック アプリのアダプター](../core/logic-app-adapter.md)
  
-   [SFTP アダプター](../core/sftp-adapter.md)  
...
-   [SAP アダプター](../core/sap-adapter.md)  
  
-   [SMTP アダプター](../core/smtp-adapter.md)  
  
-   [SOAP アダプター](../core/soap-adapter.md)  
  
-   [SQL アダプター](../core/sql-adapter.md)  
  
-   [SharePoint Services アダプター](../core/windows-sharepoint-services-adapter.md)  
...
-   [アダプターの追加情報](../core/additional-adapter-information.md)