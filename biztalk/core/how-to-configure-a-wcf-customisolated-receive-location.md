...
2.  BizTalk 管理コンソールで、展開**[!INCLUDE[prague](../includes/prague-md.md)]管理**、展開**BizTalk グループ**、展開**アプリケーション**アプリケーションを展開し、受信場所を作成するのには、します。  
