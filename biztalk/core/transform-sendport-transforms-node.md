...
ms.locfileid: "22278978"
---
# <a name="transform-sendport-transforms-node"></a>Transform (SendPort Transforms ノード)
バインド ファイルの Transforms ノードの Transform ノードには、バインド ファイルと共にエクスポートされる BizTalk Server マップに関する特定の情報が含まれます。  
