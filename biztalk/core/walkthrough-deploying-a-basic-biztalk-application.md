...
4.  下にあるドロップダウン ボックスをクリックして**厳密な名前キー ファイルを選択して**、 をクリックして**\<を参照しています.\>** 、キー ファイルを参照します。  
