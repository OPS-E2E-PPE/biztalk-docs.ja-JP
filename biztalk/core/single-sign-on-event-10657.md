...
ms.locfileid: "22272346"
---
# <a name="single-sign-on-event-10657"></a>シングル サインオン: イベント 10657
## <a name="details"></a>詳細  
...
|イベント ソース|ENTSSO|  
|コンポーネント|N\A|  
|シンボル名|SSO_INFO_PASSWORD_SYNC_ADAPTERS_STARTED|  
|メッセージ テキスト|外部アダプターのパスワード同期を開始しました。%r|  
