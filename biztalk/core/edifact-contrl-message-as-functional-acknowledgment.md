...
|UCD1|構文エラー コード|グループにエラー状態がある場合、それを識別します。 詳細については、次を参照してください。 [EDIFACT CONTRL 受信確認エラー コード](../core/edifact-contrl-acknowledgment-error-codes.md)します。<br /><br /> このデータ要素は条件付きの選択肢です。<br /><br /> **注:** XSD 検証エラーが発生した場合、UCD1 データ要素は 12 ですが、無効な値のコード値を報告します。|  
