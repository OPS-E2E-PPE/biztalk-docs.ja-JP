 ...
 **説明**  
 ...
 対象**累積**functoid は、最初の入力パラメーター (蓄積するノード) として機能しているノードよりも、送信元スキーマの異なる部分は、2 番目の入力パラメーター (蓄積範囲)。  
  
 **ユーザーの操作**  
  
 両方の入力パラメーターを指定されたことを確認してください。**累積**functoid が、同じ親レコードを共有または定数入力パラメーターが提供する 2 番目の入力パラメーター (蓄積範囲)。