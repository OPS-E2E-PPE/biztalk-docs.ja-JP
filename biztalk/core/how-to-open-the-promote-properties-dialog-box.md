...
> [!NOTE]
>  使用する場合、**クイック昇格**機能、BizTalk エディターを追加する新しい**プロパティ フィールド**プロモーションを開かなくても、**プロパティの昇格** ダイアログ ボックス昇格の表示されます ダイアログ ボックスで、次回が開かれます。  
  
 [プロパティの昇格] ダイアログ ボックスを開くには、2 つの方法があります。  
...
### <a name="to-open-the-promote-properties-dialog-box-from-any-node"></a>ノードから [プロパティの昇格] ダイアログ ボックスを開くには  
  
1.  スキーマ ツリーでノードを選択します。  
  
2.  選択したノードを右クリックし、をクリックして**昇格**、順にクリック**プロモーションの表示**  
