...
2.  コンソール ツリーで  **BizTalk Server 管理コンソール**、プロパティ スキーマ、または非表示にする schemas フォルダーを含む BizTalk グループを展開し、schemas フォルダーが含まれるアプリケーションを展開します。  
  
3.  右クリックし、**スキーマ**フォルダーで、いずれかをクリックし、**プロパティ スキーマの非表示に**または**プロパティ スキーマの**します。  
