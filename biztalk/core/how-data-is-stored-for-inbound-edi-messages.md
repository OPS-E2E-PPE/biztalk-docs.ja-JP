...
-   インターチェンジ確認状態 =\<想定または該当なし > です。 (技術確認が受信インターチェンジで構成されているか、または値が設定されている場合は、状態は "必要" になります。 それ以外の場合、状態には "適用されません" が設定されます)  
...
-   機能確認状態 =\<想定または該当なし > です。 (PAM で機能確認のタブが選択されている場合、状態は "必要" に設定されます。 それ以外の場合、状態は、該当なし に設定されます。  
