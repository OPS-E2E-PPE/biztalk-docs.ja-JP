...
### <a name="to-add-the-index-functoid-to-a-map-and-configure-it"></a>マップにインデックス functoid を追加し、構成するには  
...
4. 少なくとも 1 つのインデックス入力パラメーターを設定する、**インデックス**functoid は、次の手順に従います。  
   ...
   3.  編集ボックスで、数値の値として、インデックス入力パラメーターを入力します。 追加のインデックス値が必要ですが、クリックすると、必要に応じて繰り返します**OK**します。  
