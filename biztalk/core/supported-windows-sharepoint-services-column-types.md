...
|複数行のテキスト|SPFieldType.Note|行 1<br /><br /> 行 2<br /><br /> line 3|なし|  
...
|ハイパーリンクまたは画像|SPFieldType.URL|http://www.microsoft.com, Microsoft Web サイト|URL と表示テキストは "," で区切っています。 "Microsoft Web サイト" というテキストが http://www.microsoft.com へのハイパーリンクになります。|  
