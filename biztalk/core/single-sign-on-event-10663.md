...
---
# <a name="single-sign-on-event-10663"></a>シングル サインオン: イベント 10663
## <a name="details"></a>詳細  
...
|イベント ソース|ENTSSO|  
|コンポーネント|N\A|  
|シンボル名|SSO_INFO_EXTERNAL_PASSWORD_CHANGE_RECEIVED|  
|メッセージ テキスト|アダプターから外部パスワード変更を受信しました。%r<br /><br /> 追跡 ID: %1 %r<br /><br /> アダプター: %2 %r<br /><br /> 外部アカウント: %3 %r<br /><br /> クライアント ユーザー: %4 %r<br /><br /> クライアント コンピュータ: %5|  
  
## <a name="explanation"></a>説明  
 この情報イベントは、外部パスワード変更がアダプターから受信されたことを示します。  
