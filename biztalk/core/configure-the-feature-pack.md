...
[!INCLUDE[btsBizTalkServerNoVersion_md](../includes/btsbiztalkservernoversion-md.md)]feature pack を使用して、機能強化、機能、および Azure でよくの統合を提供します。 [!INCLUDE[featurepack1](../includes/featurepack1.md)]展開と分析、および実行時など、重要な分野の機能を拡張します。 
...
REST Api を使用すると、契約、中断されたインスタンス、参加解除のオーケストレーションなど、BizTalk artifiacts をリモートで管理します。
