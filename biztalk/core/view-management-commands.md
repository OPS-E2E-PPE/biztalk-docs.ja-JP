 ...
 **bm.exe セット rtawindow-ビュー:\<ビュー名\>-アクティビティ:\<アクティビティ名\>-名前:\<RTA 名\>- TimeLength:\<整数\>-TimeUnit:Day &#124;です。1 時間 &#124;です。分 [-サーバー:\<サーバー\> ] [-データベース:\<データベース\>]**  
...
|TimeUnit:Month &#124; 日付 &#124;です。1 時間 &#124;です。1 分|期間の単位です。|  
