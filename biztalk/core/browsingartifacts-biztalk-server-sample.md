...
#### <a name="to-run-this-sample"></a><span data-ttu-id="a233e-127">このサンプルを実行するには</span><span class="sxs-lookup"><span data-stu-id="a233e-127">To run this sample</span></span>  
